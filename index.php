...
<nav class="art-nav clearfix">
    <ul class="art-hmenu" width 220px; padding 100px><li width 220px; padding 100px><a href="#">                &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp      CATEGORIAS               &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp         </a><ul><li width 220px; padding 100px><a href="#">Subpage 1</a></li><li width 220px; padding 100px><a href="#">Subpage 2</a></li><li width 220px; padding 100px><a href="#">Subpage 3</a></li></ul></li><li width 220px; padding 100px><a href="#" class="active">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp     DISTRITOS        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp      </a><ul class="active" width 220px; padding 100px><li width 220px; padding 100px><a href="#">Alto Selva Alegre</a></li><li width 220px; padding 100px><a href="#">Yanahuara</a></li></ul></li></ul> 
    </nav>
...
<br><br>
<h1><div align="center">Insertar Distrito</div></h1>
<br><br>


<FORM METHOD="POST" ACTION="insertar_distrito.php">
Codigo<br>
<INPUT TYPE="float(2)" NAME="codigo"><br>
Categoria<br>
<INPUT TYPE="varchar(30)" NAME="distrito"><br>
<INPUT TYPE="SUBMIT" value="Insertar">
</FORM>


<br><br>
<h1><div align="center">Insertar Categoria</div></h1>
<br><br>
...
TIPO1: <INPUT type="float" name="tipo1" id="tipo1" value="0"><BR> 
TIPO2: <INPUT type="float" name="tipo2" id="tipo2" value="0"><BR> 
TIPO3: <INPUT type="float" name="tipo3" id="tipo3" value="1"><BR> 
TIPO4: <INPUT type="float" name="tipo4" id="tipo4" value="0"><BR> 
POSICION: <INPUT type="float" name="posicion" id="posicion" value="0"><BR> 
