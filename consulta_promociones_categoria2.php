...
$consulta2=mysql_query("SELECT imagen, estado, tipo2, tipo3, desc_1, desc_2, precio, negocio, url, telefono FROM promocion WHERE (now() BETWEEN fec_ini AND fec_fin ) AND estado=1 AND categoria = $var ORDER BY ranking ASC ");
